...
window.onload = function() {
  ...
  saveButton.onclick = function() {
    ...
    try {
      ...
      browser.storage.local.set(dataSet,
        function() {
  ...
  elById('configSenderIdText').onchange = function() {
    browser.storage.local.set({ configSenderId: this.value });
  }

  browser.storage.local.get(['lztext', 'configSenderId'].concat(booleanSettings), function(data) {
